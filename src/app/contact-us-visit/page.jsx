...
const CONTACT_CARDS = [
  {
    ...
    lines: ["0116 319 4784", "07538 000250"],
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-space-xl items-center">
                <div className="lg:col-span-7 space-y-space-md">
                  ...
                  <div className="pt-space-sm flex flex-wrap items-center gap-space-md">
                    <a href="tel:01163194784" className="inline-flex items-center gap-space-xs px-6 py-3.5 rounded-lg bg-secondary text-on-secondary font-label-md text-label-md hover:bg-on-secondary-container transition-all shadow-md">
                      <span className="material-symbols-outlined text-[18px]">call</span>
                      <span>Call 0116 319 4784</span>
                    </a>
            ...
            <div className="bg-inverse-surface rounded-xl p-space-xl text-on-primary shadow-xl">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-space-lg items-center">
                ...
                <div className="lg:col-span-4 flex flex-col sm:flex-row lg:flex-col gap-space-sm justify-end">
                  ...
                  <a href="tel:01163194784" className="inline-flex items-center justify-center gap-space-xs px-6 py-3.5 rounded-lg bg-surface-container-high/15 hover:bg-surface-container-high/25 text-on-primary font-label-md text-label-md transition-all">
